...
.hero .moon{position:absolute;right:-40px;top:-30px;width:340px;height:340px;z-index:0;opacity:.9;filter:drop-shadow(0 0 60px var(--accent-glow))}
@media(max-width:820px){.hero .moon{opacity:.28;right:-90px}}
